...
def get_pending_vendors(token):
    ...
    url = "https://232cf5b1-b2b3-4423-9728-8803f6e29464.preview.emergentagent.com/api/admin/vendors/pending"
    headers = {
...
def approve_vendor(token, vendor_id):
    ...
    url = f"https://232cf5b1-b2b3-4423-9728-8803f6e29464.preview.emergentagent.com/api/admin/vendors/{vendor_id}/approve"
    headers = {
        'Content-Type': 'application/json',
        'Authorization': f'Bearer {token}'
    }
