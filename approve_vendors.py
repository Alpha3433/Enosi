...
def test_login(email, password):
    ...
    url = "https://808bad13-f70b-49e5-8baf-ab76042df5d8.preview.emergentagent.com/api/auth/login"
...
def get_pending_vendors(token):
    ...
    url = "https://808bad13-f70b-49e5-8baf-ab76042df5d8.preview.emergentagent.com/api/admin/vendors/pending"
    headers = {
...
def approve_vendor(token, vendor_id):
    ...
    url = f"https://808bad13-f70b-49e5-8baf-ab76042df5d8.preview.emergentagent.com/api/admin/vendors/{vendor_id}/approve"
    headers = {
        'Content-Type': 'application/json',
        'Authorization': f'Bearer {token}'
    }
