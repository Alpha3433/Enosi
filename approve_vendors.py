...
def get_pending_vendors(token):
    ...
    url = "https://b542ea48-edd1-4904-8d51-48ed0469b0b3.preview.emergentagent.com/api/admin/vendors/pending"
    headers = {
...
def approve_vendor(token, vendor_id):
    ...
    url = f"https://b542ea48-edd1-4904-8d51-48ed0469b0b3.preview.emergentagent.com/api/admin/vendors/{vendor_id}/approve"
    headers = {
        'Content-Type': 'application/json',
        'Authorization': f'Bearer {token}'
    }
