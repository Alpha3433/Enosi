      ...
      <AnimatePresence>
        {isOpen && suggestions.length > 0 && (
          <motion.div
            ...
            className="absolute top-full mt-2 bg-white rounded-lg shadow-2xl z-50 max-h-96 overflow-y-auto border border-coral-reef"
            style={{
      ...
      <AnimatePresence>
        {isOpen && suggestions.length === 0 && !isLoading && value.length >= 2 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-full mt-2 bg-white border border-coral-reef rounded-lg shadow-xl z-50"
            style={{
              minWidth: '320px',
              width: 'max-content',
              maxWidth: '400px',
